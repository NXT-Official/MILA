...
— overlapping rather than partitioned, because a real coloring lands _between_
...
box or pill, a tagline locked to the mark. The product tagline — _"Your
stylist. Every morning."_ (`__root.tsx:51`) — travels in page titles and meta,
not in the logo.
