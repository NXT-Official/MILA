    ...
    <div>
      ...
      {overflowing && (
        <button
          ...
          aria-controls={id}
          className="atelier-focus-ring mt-1 rounded-control text-xs font-medium uppercase tracking-label text-ink underline decoration-1 underline-offset-4 hover:decoration-2"
        >
