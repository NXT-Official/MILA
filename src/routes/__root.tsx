...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Mila is your elite, studio-tuned AI stylist — tailored to your 16-season color profile and silhouette." },
      { name: "author", content: "Mila" },
      { property: "og:title", content: "Mila — Personal AI Fashion Stylist" },
      { property: "og:description", content: "Elite, studio-tuned styling for your unique color season and silhouette." },
