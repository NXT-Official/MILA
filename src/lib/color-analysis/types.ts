...
export type SeasonId =
  | 'light_spring' | 'warm_spring' | 'true_spring' | 'bright_spring'
  | 'light_summer' | 'cool_summer' | 'true_summer' | 'soft_summer'
  | 'soft_autumn' | 'warm_autumn' | 'true_autumn' | 'deep_autumn'
  | 'bright_winter' | 'cool_winter' | 'true_winter' | 'deep_winter';
