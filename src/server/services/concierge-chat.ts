...
export const ConciergeChatInput = z.object({
...
/**
 * The one implementation of a concierge turn. Called by the website's
 * `conciergeChat` and by `POST /api/v1/concierge/chat`.
 */
export async function conciergeReply({
  ...
  userId: string;
  input: z.infer<typeof ConciergeChatInput>;
